...
<br>
<?php 
echo form_open_multipart("produits/form_contact",  array('class' => 'col-12')); 
?>
        <br>
...
<!-------------------------------------------DATE------------------------------------------------------->
    ...
    <div> <label for="DatedeNaissance"> Date de Naissance* : </label><input type="date" name="date" id="date" class="form-control col-8"></div>
...
<!-------------------------------------------EMAIL------------------------------------------------------->
    ...
    <div><label for="Email"> Email* :</label> <input type="text" name="email" id="email" placeholder="dave.loper@afpa.fr" id="mail" class="form-control col-8">
...
<!-------------------------------------------VALIDER & ANNULER------------------------------------------------------->
    ...
    <p><input type="submit" name="envoyer" value="Envoyer" id="bouton_envoi"class="btn btn-success">
